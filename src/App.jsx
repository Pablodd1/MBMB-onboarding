...
function App() {
  ...
  useEffect(() => {
    if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
      ...
      recognitionRef.current.onresult = (event) => {
        ...
        if (event.results[current].isFinal && lastFocusedInput) {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(wb, `MBMB_Onboarding_${formData.business.legalName || 'Client'}.xlsx`);
    
    alert("Excel file generated! You can now upload this to your Google Drive to view it as a Google Sheet.");
  };
        ...
        <div key={provider.id} className="provider-card">
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input name={`providers.${provider.id}.cv`} value={provider.cv || ''} onChange={handleChange} onFocus={handleFocus} placeholder="URL or Doc ID" />
            </div>
            <div className="form-group">
      ...
      <main className="main-content">
        <header className="top-bar">
          ...
          <div className="actions">
            <button className="btn-secondary" onClick={() => alert('Draft saved locally!')}>
