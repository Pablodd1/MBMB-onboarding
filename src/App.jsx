...
function App() {
  ...
  const handleExportPackage = async () => {
    ...
    alert("Final Package Ready! Please email this ZIP file to intake@medicalbillingmiamibeach.com");
  };
      ...
      <div className="finish-card">
        ...
        <div className="next-steps-card">
          ...
          <ul>
            ...
            <li>Send an email to <strong>intake@medicalbillingmiamibeach.com</strong></li>
